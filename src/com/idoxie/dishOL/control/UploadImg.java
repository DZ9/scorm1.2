...
//		String dishName = new String(request.getParameter("dishName").getBytes("ISO-8859-1"),"utf-8");
...
//		ds.addDish(dishName, price, type, 0, desc, "a");
		
		String name = processRequest(request,response);
		if(name != null) {
			request.setAttribute("name", name);
		}
 		RequestDispatcher view = 
				request.getRequestDispatcher("/view/admin/dishInfo.jsp");
