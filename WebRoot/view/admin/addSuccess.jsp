...
<html>
  <head>
	...
	<link rel="stylesheet" type="text/css" href="theme/css/admin/addSuccess.css">
	<script type="text/javascript" src="theme/js/jquery-1.11.0.min.js"></script>
	<script type="text/javascript" src="theme/js/bootstrap.min.js"></script>
	<script type="text/javascript" src="theme/js/addSuccess.js"></script>
