...
try
{
   ...
   String connectionURL = "jdbc:mysql://localhost/scormms?characterEncoding=utf8\", \"root\", \"\"";

   Class.forName(driverName).newInstance();
   conn = DriverManager.getConnection("jdbc:mysql://localhost/scormms?characterEncoding=utf8","root","");
